...
*Questo articolo può essere letto anche in [Inglese](README.md), [Cinese](README-zh.md), 
[Portoghese Brasiliano](README-pt-BR.md) e [Spagnolo](README-es-ES.md).*

## Etimologia

Da dove viene il termine "README"?

Il termine risale *almeno al* 1970s e al [PDP-10](http://pdp-10.trailing-edge.com/decuslib10-04/01/43,50322/read.me.html) 
...
## Per i creatori e gli utilizzatori
...
## Molti moduli alcuni buoni altri no
...
## Tutte le strade portano al README.md
...
Grazie ai seguenti eccezionali lettori per aver comunicato errori a aver inviato PRs :heart::
...
Grazie a [@qihaiyan](https://github.com/qihaiyan) per la traduzione di Art of
README in Cinese! Anche ise guenti utenti hanno dato il loro contributo:

- [@BrettDong](https://github.com/brettdong) per la revisione della punteggiatura nelle versione Cinese.
- [@Alex-fun](https://github.com/Alex-fun)
- [@HmyBmny](https://github.com/HmyBmny)
- [@vra](https://github.com/vra)

Grazie a [@lennonjesus](https://github.com/lennonjesus) per la traduzione di Art
of README in Portoghese Brasiliano! Anche i seguenti utenti hanno dato il loro contributo:

- [@rectius](https://github.com/rectius)

Grazie a [@jabiinfante](https://github.com/jabiinfante) per la traduzione di Art
of README in Spagnolo!
